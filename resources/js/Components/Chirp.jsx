...
export default function Chirp({ chirp }) {
    ...
    console.log(chirp.comments.length);

    return (
        // flex direction column
        <div className="p-6 flex flex-col space-y-2">
            <div className="p-6 flex space-x-2">
                <img src={'storage/' + auth.user.avatar} className="w-8 h-8 rounded-full" alt="avatar" />
                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center mt-2">
                        ...
                        <button className="ml-4 text-gray-600 hover:text-gray-800" onClick={() => {setCommenting(!commenting)}}>Reply</button>
                    </div>
                    ...
                    {commenting
                        ...
                        <form onSubmit={comment}>
                            ...
                            <div className="space-x-2">
                                <PrimaryButton className="mt-4">Save</PrimaryButton>
                                <button className="mt-4" onClick={() => {setCommenting(false)}}>Cancel</button>
                            </div>
                        </form>
                    }
                </div>
